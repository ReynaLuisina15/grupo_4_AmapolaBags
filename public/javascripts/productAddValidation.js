...
$("name").addEventListener("blur", function (e) {
    switch (true) {
        case !this.value.trim():
            ...
            break;
        case this.value.length < 3 || this.value.length > 12:
            msgError("nameMsg", "el nombre debe tener entre 3 y 12 caracteres", e)
            break;
        default:
...
$("color").addEventListener("blur", function (e) {
    switch (true) {
        case !this.value:
            msgError("colorMsg", "el color del producto es obligatorio", e)
            break;
        default:
